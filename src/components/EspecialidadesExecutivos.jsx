...
export default function Especialidades() {
  ...
  return (
    <>
      ...
      <p className={styleEspecialidades.informações}>
        Os pratos executivos são individuais. Acompanham arroz, feijão, batata
        frita, ovo, farofa, salada e vinagrete.
      </p>
      ...
      <div className={styleEspecialidades.containerMaster}>
        <div className={styleEspecialidades.container}>
          ...
          <p className={styleEspecialidades.informacoesDetalhes}>
            Os executivos são pratos individuais. Acompanham arroz, feijão,
            batata frita, ovo, farofa, salada e vinagrete.
          </p>
