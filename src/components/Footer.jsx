    ...
    <>
      <footer className={styleFooter.Footer}>
        <span>
          ...
          <p className={styleFooter.Informacoes}>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe
            repellat, et earum quam labore nulla atque maxime neque voluptates
            repudiandae, sit voluptatum modi aperiam rem! Tempora consequatur
            minus deleniti commodi.
          </p>
      ...
      <div className={styleFooter.Direitos}>
        <h1 className={styleFooter.TituloDireitos}>
          Todos os direitos reservados. Copyright © 2022 by Costelaria Goes
        </h1>
      </div>
    </>
  );
