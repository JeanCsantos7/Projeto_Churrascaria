  ...
  return (
    <>
      ...
      <p className={styleEspecialidades.informações}>
        As especialidades são pratos grandes que servem de 3 a 4 pessoas.
        Acompanham arroz, feijão, batata frita, mandioca frita, farofa, salada e
        vinagrete.
      </p>
      ...
      <div className={styleEspecialidades.containerMaster}>
        <div className={styleEspecialidades.container}>
          ...
          <p className={styleEspecialidades.informacoesDetalhes}>
            As especialidades são pratos grandes que servem de 3 a 4 pessoas.
            Acompanham arroz, feijão, batata frita, mandioca frita, farofa,
            salada e vinagrete.
          </p>
