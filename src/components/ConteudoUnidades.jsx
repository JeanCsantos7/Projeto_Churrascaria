  ...
  const lista = [
    {
      id: "1",
      local: "Unidade Moema",
      endereco: "Av. Ibirapuera, 2401, Moema São Paulo – SP",
      horario: "Seg. a Sex. das 10h30 às 21h Sáb. das 11h30 às 00h10",
      imagem: UnidadeMoema,
    },
    {
      id: "2",
      local: "Unidade Santo Amaro",
      endereco: "Av. Adolfo Pinheiro, 1735, Santo Amaro",
      horario: "Seg. a Sex. das 10h30 às 21h Sáb. das 11h30 às 00h10",
      imagem: UnidadeStoAmaro,
    },
    {
      id: "3",
      ...
      horario: "Seg. a Sex. das 10h30 às 21h Sáb. das 11h30 às 00h10",
      imagem: UnidadeSantana,
    },
    {
      id: "4",
      local: "Unidade Osasco",
      endereco: "R. Salém Bechara, 140, Centro, Osasco São Paulo – SP",
      horario: "Seg. a Sex. das 10h30 às 21h Sáb. das 11h30 às 00h10",
      imagem: UnidadeOsasco,
    },
    {
      id: "5",
      local: "Unidade Paulista",
      endereco: "Av Paulista, 2444, Consolação São Paulo – SP",
      horario: "Seg. a Sex. das 10h30 às 21h Sáb. das 11h30 às 00h10, ",
      imagem: UnidadePaulista,
    },
  ];
            ...
            <>
              <div className={styleUnidades.Container} key={cardItem.id}>
                <span className={styleUnidades.informacoesCards}>
                  ...
                  <p className={styleUnidades.paragrafoCard}>
                    {cardItem.endereco}
                  </p>
                  <p className={styleUnidades.paragrafoCard}>
                    {cardItem.horario}
                  ...
                  <img
                    className={styleUnidades.imagemCard}
                    src={cardItem.imagem}
                    alt=""
                  />
                </span>
