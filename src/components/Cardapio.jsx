...
export default function Cardapio({ termoPesquisa }) {
  ...
  const pratosExecutivos = [
    {
      ...
      preco: "R$59,90",
      informacoes:
        "Lorem ipsum dolor adipisicing elit.  provident adipisci, totam eligendi atque libero, ipsam autem!",
    },
    {
      id: 2,
      imagem: Executivo2,
  ...
  const PratosGrandesFiltro = pratosGrandes.filter((teste) => {
    return teste.NomeCarne.toLowerCase().includes(termoPesquisa.toLowerCase());
  });
